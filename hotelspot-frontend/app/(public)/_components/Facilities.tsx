...
export default function Facilities() {
  ...
  return (
    <section
      id="facilities"
      className="relative w-full h-[650px] overflow-hidden bg-black"
    >
      {/* Dark Overlay */}
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full px-6">
        ...
        <div className="absolute bottom-12">
          <button
            ...
            className="w-20 h-20 rounded-full border border-white/40 flex items-center justify-center hover:scale-110 transition"
          >
            {playing ? (
